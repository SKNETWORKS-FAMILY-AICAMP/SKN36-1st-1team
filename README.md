...
| 팀원           | 주요 역할                                                                                                                                            |
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| **민지** | 데이터 수집·전처리 · 모델 매핑 데이터 구축 · DB 연동 · 모델 비교 기능 · Streamlit 데이터 연계 및 UI 통합 · Git/GitHub 관리 · 문서 정합성 관리 |
| **홍진** | 요구사항정의서 작성 · FAQ 데이터 · 판매 데이터 크롤링 · README 및 프로젝트 문서화 · 발표                                                        |
| **소희** | 데이터정의서 작성 · ERD 설계 · DB 테이블 생성 · 데이터 적재 · SQL 조회 쿼리 작성                                                                 |
| **성희** | 화면설계서 작성 · User Flow 설계 · Streamlit UI 구성 및 화면 구현                                                                                  |
